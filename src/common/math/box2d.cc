...
double Box2d::DistanceTo(const LineSegment2d& line_segment) const {
    ...
    if (gx1 == 1 && gy1 == 1) {
        ...
        case 3: return (x1 > x2) ? (x2 - box_x) : PtSegDistance(box_x, box_y, x1, y1, x2, y2, line_segment.length());
        case 2:
        ...
        switch (gx2 * 3 + gy2) {
        case 4: return (x1 < x2) ? (x1 - box_x) : PtSegDistance(box_x, box_y, x1, y1, x2, y2, line_segment.length());
...
std::string Box2d::DebugString() const {
    return ::common::StrCat("box2d ( center = ",
                            center_.DebugString(),
                            "  heading = ",
                            heading_,
                            "  length = ",
